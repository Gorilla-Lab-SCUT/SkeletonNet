...
import data_sdf_h5_queue_skevox as data
...
if not FLAGS.test_allset:
    ...
    cat_id, modname, render = img_path[0], img_path[1], int(img_path[2])
    cats_limit[cat_id] += 1
    TEST_LISTINFO += [(cat_id, modname, render)]
else:
    for cat_id in cat_ids:
        ...
        with open(test_lst, 'r') as f:
            ...
            for line in lines:
                render_list = [0] #random.sample(range(24), FLAGS.view_num)
