                        ...
                        try:
                            if FLAGS.mesh_sample:
                                ...
                                if num_left>0:
                                    ...
                                    verts_batch[i+1, :FLAGS.num_points_pred] = vertices
                            else:
                                num_left = FLAGS.num_points_pred - mesh1.vertices.shape[0]
                                if num_left>0:
                                    samples = np.zeros((0,3), dtype=np.float32)
...
if __name__ == "__main__":
    ...
    surface_dir = '/data1/tang.jiapeng/ShapeNetV1_surface_skeleton'
    cd_emd_all(cats, FLAGS.cal_dir, surface_dir, FLAGS.test_lst_dir, explicit)