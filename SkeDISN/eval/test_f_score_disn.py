...
if FLAGS.baselines:
    name = (FLAGS.cal_dir).split('/')[-1] + '_fscore'
else:
    name = (FLAGS.cal_dir).split('/')[-3] + '_fscore'
...
if __name__ == "__main__":
    ...
    cal_f_score_all_cat(cats, FLAGS.cal_dir, '/data1/tang.jiapeng/ShapeNetV1_surface_skeleton', \
