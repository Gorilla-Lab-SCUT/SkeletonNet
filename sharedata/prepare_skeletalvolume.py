...
parser.add_argument('--vx_res', type=int, default=32)
...
def worker(cat_mod):
    ...
    if FLAGS.saveobj:
        #ouput .obj
        outfile = os.path.join(outdir, '%d_fill.obj'%FLAGS.vx_res)
        ...
        # output .npz
        outfile = os.path.join(outdir, '%d_fill.h5'%FLAGS.vx_res)
